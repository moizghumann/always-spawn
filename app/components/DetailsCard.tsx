...
const DetailsCard = ({ heading, cost, description, agentInfo }: DetailsProps) => {
    return (
        <div style={{ backgroundColor: 'white', width: 370, borderRadius: 14, padding: '20px 18px 20px 18px', boxShadow: '0 2px 8px rgba(0, 0, 0, 0.15)' }}>
